...
export class GroupAddRealmRoleMappingsActionProcessor extends BaseGroupRealmRoleMappingsActionProcessor {
    ...
    getValidationSchema(): Joi.SchemaLike | null {
        return GroupAddRealmRoleMappingsActionProcessor.validationSchema;
    }
    ...
    async execute(): Promise<void> {
        ...
        await this.addRoleMappings(adminClient, group.id, realmName, realmRoles, mappings);
    }
}
