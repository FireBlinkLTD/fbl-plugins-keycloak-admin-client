...
export class UserAddRealmRoleMappingsActionProcessor extends BaseUserRealmRoleMappingsActionProcessor {
    ...
    getValidationSchema(): Joi.SchemaLike | null {
        return UserAddRealmRoleMappingsActionProcessor.validationSchema;
    }
    ...
    async execute(): Promise<void> {
        ...
        await this.addRoleMappings(adminClient, user.id, realmName, realmRoles, mappings);
    }
}
