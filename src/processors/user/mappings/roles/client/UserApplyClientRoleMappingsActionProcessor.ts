...
export class UserApplyClientRoleMappingsActionProcessor extends BaseUserClientRoleMappingsActionProcessor {
    ...
    getValidationSchema(): Joi.SchemaLike | null {
        return UserApplyClientRoleMappingsActionProcessor.validationSchema;
    }
    ...
    async execute(): Promise<void> {
        ...
        await this.deleteRoleMappings(adminClient, user.id, client, realmName, rolesToRemove, mappings);

        await this.addRoleMappings(adminClient, user.id, client, realmName, rolesToAdd, mappings);
    }
}
